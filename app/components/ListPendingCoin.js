...
const ListPendingCoin = ({onPressItem, data}) => {
    ...
    return (
      <VStack
        ...
        <Box w={'100%'}>
          ...
          <Text fontWeight={'bold'}>{item.nominal + ' coin'}</Text>
        </Box>
        <Button
  ...
  return (
    <FlatList
      ListEmptyComponent={() => {
        return (
          <Box w={'100%'}>
            <Text textAlign={'center'}>Belum ada coin yang dapat ditarik</Text>
          </Box>
        );
      }}
...
export default ListPendingCoin;
